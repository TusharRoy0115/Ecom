...
def payment(request):
    ...
    store_id = 'abc5fa650d620f3f'
    API_key = 'abc5fa650d620f3f@ssl'
    ...
    order_total  = order_qs[0].get_totals()
    mypayment.set_product_integration(total_amount=(order_total), currency='BDT', product_category='Mixed', product_name=order_items, num_of_item=order_items_count, shipping_method='Courier', product_profile='None')
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        if status == 'VALID':
            ...
            messages.warning(request,f"Your Payment failed!! Plz Try Again!!")
...
def order_view(request):
    try:
        ...
        mesages.warning(request,"You do not have an active order")
